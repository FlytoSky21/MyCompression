...
# from models.dcc2023_edge_grad import DCC2023Model
...
def parse_args(argv):
    ...
    parser.add_argument("--save_path", type=str,
                        default='/home/adminroot/taofei/MyCompression/result/grad_joint_training/flicker/concate_rrdb', help="save_path")
    parser.add_argument(
